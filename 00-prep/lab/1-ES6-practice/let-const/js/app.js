...
function displayPics(){
  ...
  // Response: Because const is block-scoped, and thus scoped only within the while statement above it. Moving the console log works if I moved it into the while loop.
  console.log(viewed);
